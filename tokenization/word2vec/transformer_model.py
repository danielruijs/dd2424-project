...
class PositionalEmbedding(keras.layers.Layer):
    ...
    def __init__(self, word_embeddings):
        super().__init__()
        vocab_size, self.d_model = word_embeddings.shape
...
class Decoder(tf.keras.layers.Layer):
    def __init__(self, *, word_embeddings, num_layers, num_heads, dff, dropout_rate=0):
        super().__init__()

        self.d_model = word_embeddings.shape[1]
        self.num_layers = num_layers

        self.pos_embedding = PositionalEmbedding(word_embeddings)
...
class Transformer(keras.Model):
    def __init__(
        ...
        self.dense = keras.layers.Dense(word_embeddings.shape[0])
